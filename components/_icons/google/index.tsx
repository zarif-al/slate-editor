...
export function IconGoogle({ size }: IconProps): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="M3.15302 7.8455L6.43851 10.255C7.32751 8.054 9.48052 6.5 12 6.5C13.5295 6.5 14.921 7.077 15.9805 8.0195L18.809 5.191C17.023 3.5265 14.634 2.5 12 2.5C8.15902 2.5 4.82802 4.6685 3.15302 7.8455Z"
        fill="#FF3D00"
      />
      <path
        d="M12 22.5C14.583 22.5 16.93 21.5115 18.7045 19.904L15.6095 17.285C14.5718 18.0742 13.3038 18.501 12 18.5C9.39903 18.5 7.19053 16.8415 6.35853 14.527L3.09753 17.0395C4.75253 20.278 8.11353 22.5 12 22.5Z"
        fill="#4CAF50"
      />
      <path
